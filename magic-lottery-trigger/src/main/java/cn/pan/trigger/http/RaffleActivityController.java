...
import cn.pan.domain.activity.service.IRaffleActivityAccountQuotaService;
import cn.pan.domain.activity.service.IRaffleActivityPartakeService;
import cn.pan.domain.activity.service.armory.IActivityArmory;
import cn.pan.domain.award.model.entity.UserAwardRecordEntity;
import cn.pan.domain.award.model.valobj.AwardStateVO;
import cn.pan.domain.award.service.IAwardService;
...
public class RaffleActivityController implements IRaffleActivityService {
     ...
     * 入参：{"activityId":100301,"userId":"MyPJSix"}
     *
     * curl --request POST \
     ...
     * 入参：MrPJSix
     * <p>
     * curl -X POST http://localhost:8091/api/v1/raffle/activity/calendar_sign_rebate -d "userId=MrPJSix" -H "Content-Type: application/x-www-form-urlencoded"
     */
     ...
     * 判断是否签到接口
     * <p>
     * curl -X POST http://localhost:8091/api/v1/raffle/activity/is_calendar_sign_rebate -d "userId=MrPJSix" -H "Content-Type: application/x-www-form-urlencoded"
     */
